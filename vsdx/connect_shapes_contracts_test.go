...
//
// The audit (Hot zone #3 + EC-008) flagged this as one of the highest-risk
// surfaces because of the embedded-media + ID-remap interaction. The
// master-collision bug — fixed in commit b6f709b — happened because the
...
// EC-008 REGRESSION: master-collision. The connector's master must resolve
...
// (commit b6f709b) sets MasterPageID to "Dynamic connector" explicitly.
