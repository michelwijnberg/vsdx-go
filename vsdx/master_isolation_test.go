...
// the bug catalogued in EDIT_CONTRACTS phase 1: when a shape has no local
...
//
// The repro fixture is logical-architecture.vsdx (in the VisiGo repo), which
...
func TestMasterIsolation_GeometryRowMutationDoesNotLeakAcrossInstances(t *testing.T) {
	const fixture = "/home/michel/VisiGo/examples/logical-architecture.vsdx"
